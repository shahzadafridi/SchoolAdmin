...
class ClassesAdapter(context: Context) : BaseAdapter() {

    var mCtx: Context
    var list: List<Classes> = arrayListOf()
    ...
    fun setClassesList(list: List<Classes>){
        this.list = list
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.title!!.text = list.get(position).`class`
        return retView
    }
